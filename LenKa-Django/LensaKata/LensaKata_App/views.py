...
from .models import Kursus, VideoDetail
...
def kursus_list(request):
    ...
    return render(request, 'kursus.html', {'kursus_list': kursus_list})
...
def video_detail(request, kursus_id):
    ...
    return render(request, 'video_detail.html', {'kursus': kursus, 'video_details': video_details})
